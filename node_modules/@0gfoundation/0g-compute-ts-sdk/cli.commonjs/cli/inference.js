...
const MULTIPLIER_SCALE = 1000000n;
function applyMultiplier(base, mul) {
    ...
    program
        ...
        await (0, util_1.withROBroker)(options, async (broker) => {
            ...
            services.forEach((service, index) => {
                ...
                const isSpeechService = service.serviceType === 'speech-to-text';

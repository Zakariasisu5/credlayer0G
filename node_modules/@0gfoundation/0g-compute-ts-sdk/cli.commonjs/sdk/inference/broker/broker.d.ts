...
import type { AdapterInfo, AdapterStatusResponse, DeployResponse, DeployAdapterOptions, ChatResponse, ChatOptions } from './lora';
 ...
 */
export declare class InferenceBroker extends ReadOnlyInferenceBroker {
     ...
     */
    verifyService: (providerAddress: string, outputDir?: string, onLog?: (step: VerificationStep) => void) => Promise<VerificationResult | null>;
    /**

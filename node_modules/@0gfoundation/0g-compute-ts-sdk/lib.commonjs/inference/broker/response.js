...
class ResponseProcessor extends base_1.ZGServingUserBrokerBase {
    ...
    async processResponse(providerAddress, chatID, content // For chatbot: usage JSON with input_tokens/output_tokens; For speech-to-text: usage JSON, duration-billed ({"type":"duration","seconds":N}) or token-billed ({"type":"tokens",...}); For text-to-image: empty/undefined
    ) {
        try {

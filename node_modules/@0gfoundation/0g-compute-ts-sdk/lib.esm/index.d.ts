import { DeferredTopicFilter, EventFragment, EventLog, ContractTransactionResponse, FunctionFragment, ContractTransaction, LogDescription, Typed, TransactionRequest, BaseContract, ContractRunner, Listener, AddressLike, BigNumberish, BytesLike, ContractMethod, Interface, Result, JsonRpcProvider, JsonRpcSigner, Wallet, ContractMethodArgs as ContractMethodArgs$3, ContractTransactionReceipt, ethers } from 'ethers';
...
declare class ReadOnlyInferenceServingContract {
...
declare class InferenceServingContract extends ReadOnlyInferenceServingContract {
...
declare class ReadOnlyFineTuningServingContract {
...
declare class FineTuningServingContract extends ReadOnlyFineTuningServingContract {
    signer: Wallet;
    private _userAddress;
    private _gasPrice?;
    private _maxGasPrice?;
...
declare class RequestProcessor extends ZGServingUserBrokerBase {
    ...
    getRequestHeaders(providerAddress: string, 
    /** @deprecated No longer used. Kept for backward compatibility. */
    _content?: string): Promise<ServingRequestHeaders>;
    /**
...
declare abstract class ZGServingUserBrokerBase {
    ...
    getQuote(providerAddress: string): Promise<TdxQuoteResponse$1>;
...
type AdapterState = 'init' | 'pending' | 'downloading' | 'ready' | 'active' | 'loading' | 'offloaded' | 'archived' | 'failed';
...
interface DeployAdapterOptions {
    wait?: boolean;
 ...
 */
declare function parseTieredPricing(additionalInfo: string): TieredPricingInfo | undefined;
/**
 * Cache token billing configuration parsed from service additionalInfo or modelInfo.
 */
interface CacheTokenBillingInfo {
    divisor: number;
}
/**
 ...
 * Returns undefined if not present or invalid.
 */
declare function parseCacheTokenBilling(additionalInfo: string): CacheTokenBillingInfo | undefined;
/**
 ...
 */
declare class ReadOnlyModelProcessor$1 {
 ...
 */
declare class ReadOnlyInferenceBroker {
    protected modelProcessor: ReadOnlyModelProcessor$1;
 ...
 * ```
 */
declare function createReadOnlyInferenceBroker(rpcUrl: string, chainId?: number): Promise<ReadOnlyInferenceBroker>;
...
interface VerificationStep$1 {
    type: 'info' | 'success' | 'error' | 'warning' | 'step';
    message: string;
}
interface SignerReportMatch$1 {
    reportType: string;
    address: string;
    match: boolean;
}
interface VerificationResult$1 {
    ...
    signerVerification?: {
        ...
        reportAddresses: SignerReportMatch$1[];
        allMatch: boolean;
    };
    composeVerification?: {
        passed: boolean;
...
declare class Verifier extends ZGServingUserBrokerBase {
     ...
     */
    verifyService(providerAddress: string, outputDir?: string, onLog?: (step: VerificationStep$1) => void): Promise<VerificationResult$1>;
    /**
    ...
    getQuoteInLLMServer(providerBrokerURL: string, model: string): Promise<TdxQuoteResponse$1>;
 ...
 */
declare class ModelProcessor$1 extends ReadOnlyModelProcessor$1 {
    protected contract: InferenceServingContract;
    protected ledger: LedgerBroker;
    protected metadata: Metadata;
    protected cache: Cache;
 ...
 */
declare class InferenceBroker extends ReadOnlyInferenceBroker {
    requestProcessor: RequestProcessor;
    responseProcessor: ResponseProcessor;
    verifier: Verifier;
    accountProcessor: AccountProcessor;
    loraProcessor: LoRAProcessor;
    modelProcessor: ModelProcessor$1;
    private signer;
    private ledger;
     ...
     * ```
     */
    startAutoFunding: (providerAddress: string, config?: AutoFundingConfig, gasPrice?: number) => Promise<void>;
    /**
     * Stop background auto-funding for a provider.
     *
     * @param {string} providerAddress - The provider address. If omitted, stops all auto-funding timers.
     */
    stopAutoFunding: (providerAddress?: string) => void;
    /**
     ...
     */
    verifyService: (providerAddress: string, outputDir?: string, onLog?: (step: VerificationStep$1) => void) => Promise<VerificationResult$1 | null>;
    /**
     ...
     */
    chatWithFineTunedModel: (providerAddress: string, adapterName: string, message: string, options?: ChatOptions) => Promise<ChatResponse>;
}
/**
 ...
 * Works without authentication - only requires a read-only contract.
 */
declare class ReadOnlyModelProcessor {
 ...
 */
declare class ModelProcessor extends ReadOnlyModelProcessor {
 ...
 * Works without authentication - only requires a read-only contract.
 */
declare class ReadOnlyServiceProcessor {
    protected contract: ReadOnlyFineTuningServingContract;
    constructor(contract: ReadOnlyFineTuningServingContract);
    /**
...
declare class ServiceProcessor extends ReadOnlyServiceProcessor {
    protected contract: FineTuningServingContract;
    protected ledger: LedgerBroker;
    protected servingProvider: Provider;
    protected automata: Automata;
 ...
 * - Browse services without authentication
 */
declare class ReadOnlyFineTuningBroker {
 ...
 */
declare function createReadOnlyFineTuningBroker(rpcUrl: string, chainId?: number): Promise<ReadOnlyFineTuningBroker>;

declare class FineTuningBroker extends ReadOnlyFineTuningBroker {
    private signer;
    private fineTuningCA;
    private ledger;
...
declare const CONTRACT_ADDRESSES: {
    readonly testnet: {
        ...
        readonly fineTuning: "0xC6C075D8039763C8f1EbE580be5ADdf2fd6941bA";
    };
    readonly testnetDev: {
    ...
    readonly mainnet: {
        ...
        readonly fineTuning: "0x4e3474095518883744ddf135b7E0A23301c7F9c0";
    };
    readonly hardhat: {
 ...
 */
declare class ZGComputeNetworkReadOnlyBroker {
 ...
 * @throws An error if the broker cannot be initialized.
 */
declare function createZGComputeNetworkReadOnlyBroker(rpcUrl: string, chainId?: number): Promise<ZGComputeNetworkReadOnlyBroker>;
...
export { CONTRACT_ADDRESSES, FineTuningBroker, HARDHAT_CHAIN_ID, AccountProcessor as InferenceAccountProcessor, InferenceBroker, ModelProcessor$1 as InferenceModelProcessor, RequestProcessor as InferenceRequestProcessor, ResponseProcessor as InferenceResponseProcessor, Verifier as InferenceVerifier, LedgerBroker, MAINNET_CHAIN_ID, ReadOnlyFineTuningBroker, ReadOnlyInferenceBroker, TESTNET_CHAIN_ID, ZGComputeNetworkBroker, ZGComputeNetworkReadOnlyBroker, createFineTuningBroker, createInferenceBroker, createLedgerBroker, createReadOnlyFineTuningBroker, createReadOnlyInferenceBroker, createZGComputeNetworkBroker, createZGComputeNetworkReadOnlyBroker, getCryptoAdapter, getNetworkType, hasWebCrypto, isBrowser, isDevMode, isNode, isWebWorker, parseCacheTokenBilling, parseTieredPricing };
export type { CacheTokenBillingInfo, CryptoAdapter, ServiceStructOutput as FineTuningServiceStructOutput, AccountStructOutput as InferenceAccountStructOutput, ServiceStructOutput$1 as InferenceServiceStructOutput, ServingRequestHeaders as InferenceServingRequestHeaders, SingerRAVerificationResult as InferenceSingerRAVerificationResult, PricingTier, ProviderModelInfo, ServiceWithDetail, TieredPricingInfo };
